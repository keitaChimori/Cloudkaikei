      ...
      <form action="" method="post">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-7">
                    <div class="form-group">
                      ...
                      <input name="KanaName" type="text" id="inputKanaName" class="form-control"
                ...
                <div class="form-group">
                  ...
                  <input name="Mail" type="text" id="inputMail" class="form-control"
                  value="<?php echo $value['mail']; ?>">
                </div>

                <div class="form-group">
                  <label for="inputPost">郵便番号</label>
                  <input name="Post" type="text" id="inputPost" class="form-control"
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input name="Address1" type="text" id="inputAddress1" class="form-control"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input name="Address2" type="text" id="inputAddress2" class="form-control"
                ...
                <div class="form-group">
                  ...
                  <input name="Phone" type="tel" id="inputPhone" class="form-control"
                  value="<?php echo $value['tel']; ?>">
                </div>
                <div class="form-group">
                  <label for="inputFax">FAX</label>
                  <input name="Fax" type="tel" id="inputFax" class="form-control"
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input name="Bank" type="text" id="inputBank" class="form-control"
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="BankAccount" type="text" id="inputBankAccount" class="form-control"
        ...
        <div class="row">
          <div class="col-12">
            ...
            <input type="submit" value="変更を保存" class="btn btn-success float-right">
          </div>
        </div>
